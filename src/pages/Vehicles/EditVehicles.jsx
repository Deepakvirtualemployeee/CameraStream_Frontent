            ...
            <div className="container-fluid" style={{ maxWidth: 'calc(1000px + 1.5rem)' }}>
                <div className="heading-wrapper d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div className="btn-wrapper d-flex flex-wrap gap-2">
                        ...
                        <Button variant='outline-danger'>Unassign ELD</Button>
                        <Button variant='outline-danger'>Deactivate</Button>
                        <Button variant="primary" type="submit" form="edit-vehicle-form">Save Changes</Button>
                    </div>
                </div>
                    ...
                    <Form id="edit-vehicle-form" onSubmit={handleSubmit}>
                        ...
                        <section>
                            ...
                            <div className="bg-white w-100 border rounded-4 shadow-sm px-3 px-md-4 py-4">
                                <Form.Group controlId="assignEld">
                                    <Form.Label>Assign ELD</Form.Label>
                                    <Form.Select
                                        name="assignEld"
                                        value={formData.assignEld}
                                        onChange={handleChange}
                                        required
                                    >
