...
export const UsersManagement = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            sortable: true,
            minWidth: '80px',
            cell: (row) => <Badge className='fs-12 fw-medium bg-opacity-10' pill bg={row.user_status === 'Active' ? 'success text-success' : row.user_status === 'Pending' ? 'danger text-danger' : row.user_status === 'In Process' ? 'warning text-dark' : 'primary'}>{row.user_status}</Badge>,
        },
        {
            name: 'Actions',
            minWidth: '150px',
